...
import { quizQuestions } from "@/lib/lesson-three";
import { lessons } from "@/lib/lessons";

const lesson = lessons.find((item) => item.id === "logos")!;

/** Lesson 3's scored quiz, rewarding XP, coins and the Logo Expert badge. */
export function LogoQuiz() {
