...
import { quizQuestions } from "@/lib/lesson-one";
import { lessons } from "@/lib/lessons";

const lesson = lessons[0];

/** Lesson 1's scored quiz, rewarding XP, coins and a BrandQuest badge. */
  ...
  return (
    ...
    >
      ...
      <p className="mt-5 font-display text-2xl font-bold text-detective-blue-900">
        ⭐ Junior Brand Detective badge earned!
      </p>
    </motion.div>
  );
}
