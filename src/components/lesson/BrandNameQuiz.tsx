...
import { quizQuestions } from "@/lib/lesson-two";
import { lessons } from "@/lib/lessons";

const lesson = lessons.find((item) => item.id === "brand-names")!;

/** Lesson 2's scored quiz, rewarding XP, coins and the Brand Name Explorer badge. */
export function BrandNameQuiz() {
  ...
  return (
    ...
    >
      ...
      <p className="mt-5 font-display text-2xl font-bold text-detective-blue-900">
        🏷️ Brand Name Explorer badge earned!
      </p>
